...
Portable Text blocks, each proven end to end against EmDash 0.41.0:
...
## EmDash 0.41.0 compatibility baseline

The verified compatibility target is exact EmDash 0.41.0. Consumers should
...
field in the admin or its Block Kit modal. This is the verified 0.41.0 fallback,
